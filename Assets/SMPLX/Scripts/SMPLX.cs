...
public class SMPLX : MonoBehaviour
{
    ...
    internal Vector3[] _jointPositions = null;
    internal Quaternion[] _jointRotations = null;
    ...
    internal Dictionary<string, Transform> _transformFromName;
